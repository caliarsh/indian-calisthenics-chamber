...
import { ArrowDown, ArrowUpRight, AtSign, CalendarDays, MapPin, Trophy } from 'lucide-react';
...
export default function OfflineTrainingPage() {
  ...
  return <main className="offline-page"><SiteHeader />
    ...
    <section className="section competition-section" id="competition">
      ...
      <div className="competition-heading"><div><p className="section-kicker">Competition at ICC</p><span>{competition.status}</span><h2>{competition.name}<br /><em>{competition.discipline}</em></h2></div><Trophy aria-hidden="true" /></div>

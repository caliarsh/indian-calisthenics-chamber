...
export default function OfflineTrainingPage() {
  return <main className="offline-page"><SiteHeader />
    <section className="offline-hero" id="top"><div className="offline-hero-media"><Image src="/icc-community-hero.jpeg" width={1280} height={1177} alt="Indian Calisthenics Chamber athletes and community members gathered inside the academy" priority unoptimized sizes="100vw" /></div><div className="hero-content"><p className="eyebrow"><span /> Bengaluru · Hyderabad</p><h1>Train at<br /><em>ICC.</em></h1><p className="hero-copy">Coach-led calisthenics training, level-matched progressions, and a community built around consistent work.</p><div className="hero-actions"><a className="button" href="/book-trial?mode=Offline">Book an offline trial <ArrowUpRight /></a><a className="text-link" href="#pricing">View pricing <ArrowDown /></a></div></div></section>

  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        ...
        <img className="hero-image" src="/icc-group-hero.png" alt="Members of Indian Calisthenics Chamber gathered together inside the Bengaluru training facility" width="1672" height="941" fetchPriority="high" />

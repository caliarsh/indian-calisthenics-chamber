  ...
  return <Tabs className="pricing-tabs" defaultValue="group">
    ...
    <TabsContent className="pricing-tab-content" value="pt">
      <div className="trainer-picker">
        <div><p className="section-kicker">Choose your coach</p><h3>Personal Training</h3><p>Arsh and Abhishek are ₹3,000 per session. Other ICC coaches are ₹2,000 per session.</p></div>
